...
\author{张舒昱}
\title{Sustech Beamer Template}
\subtitle{毕业设计开题报告}
\institute{南方科技大学计算机科学与技术系}
\date{2021年2月23日}
\usepackage{Sustech}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.2\linewidth]{pic/Sustech_University_Logo.eps}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{用Beamer很高大上？}
    \begin{itemize}[<+-| alert@+>] % 当然，除了alert，手动在里面插 \pause 也行
        ...
        \item GitHub项目地址位于 \url{https://github.com/Lionelsy/SUSTech-Beamer-Template}，如果有bug或者feature request可以去里面提issue
    \end{itemize}
\end{frame}
